...
| Dictée en cours, jamais conclue | **Abandonnée (onglet mort) avec audio : l'audio rejoint le brouillon et suit sa rétention** (enregistrement conservé jusqu'à la suppression du brouillon, brouillon marqué « Abandonnée »). **Quasi vide** (< 10 s d'audio) : supprimée, session et brouillon vide compris. Une dictée simplement **en pause** n'est jamais marquée (scrutation du navigateur) | À l'ouverture de la liste des brouillons (aucune boucle de fond) ; purge de rétention au démarrage et à l'accès à la liste des brouillons |
