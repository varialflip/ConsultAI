...
- **Largeur de ligne ramenée à 89 caractères** (`LINE_WIDTH`) : un caractère
  sous la limite du dossier médical. Les colonnes de la liste pointée deux
  colonnes passent à 43 (`MEDS_COLUMN_WIDTH`, partagée avec les médicaments) :
