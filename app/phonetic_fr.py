"""
Vendored — Soundex FR (algorithme phonétique français)
=======================================================
Copie fidèle du paquet PyPI ``phonetic-fr`` (port Python par Gaspard PETIT de
« SOUNDEX FR » d'Édouard BERGÉ, PHP 12.2007 v1.2), licence MIT — volontairement
ZÉRO dépendance, comme le reste de l'application.

Source : https://github.com/gaspardpetit/phonetic_fr-py (vendu à l'identique,
y compris l'en-tête MIT de ce module). Ne PAS modifier le code en aval de ce
bloc : toute correction remonte à l'upstream, sinon le documenter ici.

Usage dans ConsultAI : ``app.drug_lookup._phonetic_code`` fournit la clé
phonétique d'un nom de médicament transcrit (erreurs PHONÉTIQUES du STT, pas
orthographiques — voir le repli flou du § 13 du README).
"""
