...
| **Aligné** | Texte seul avec listes alignées : puces et numérotées au retrait suspendu, numéros élargis à une colonne, indentation conservée en champ riche (espaces insécables) — idéal pour le dossier électronique. Les tableaux Markdown y sont rendus en liste pointée sur deux colonnes : un en-tête de rubrique (p. ex. « Médicaments ») est conservé en titre, et selon le tableau chaque cellule ou chaque rangée devient une puce |
