...
- **Largeur de ligne portée de 89 à 90 caractères** (`LINE_WIDTH`) : un
  caractère de plus que la marge d'origine, sans atteindre la limite du dossier
  médical. Les colonnes de la liste pointée deux colonnes restent à 44
  (`MEDS_COLUMN_WIDTH`, partagée avec les médicaments) : 44 + 2 + 44 = 90
  remplit exactement la largeur (un total de 92 débordait et cassait la liste
  des médicaments).
