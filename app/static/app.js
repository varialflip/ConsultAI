...
(function () {
  ...
  //: 43 = (LINE_WIDTH − 2) / 2 arrondi vers le bas : deux colonnes égales et
  //: l'écart de 2 tiennent sous la marge du DME (43 + 2 + 43 = 88 ≤ 89).
  const MEDS_COLUMN_WIDTH = 43;
  ...
  //: jamais sous la puce elle-même. 89 = marge du DME (largeur d'origine,
  //: un caractère sous la limite de la largeur du dossier).
  const LINE_WIDTH = 89;
