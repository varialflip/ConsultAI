...
"privacy.q6_body": (
    ...
    "copy.aligned_title": (
        ...
        "note, alignements de colonnes respectés (centré/droite via les « : » "
        "du Markdown).",
        ...
        "field (non-breaking spaces). Tables are rendered as full-width "
        "Unicode boxes (┌ ┬ ┐ ├ ┼ ┤ └ ┴ ┘) honoring column alignment "
        "(center/right via Markdown colons).",
    ),
    "copy.aligned_done": (
