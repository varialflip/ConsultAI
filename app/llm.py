...
def build_extract_user_prompt(
    ...
    tache = (
        ...
        "probable dans sa rubrique ET une ligne en « corrections ». Un item par "
        "ligne, contexte complet et grammatical, au format "
        "« [Rubrique] ...contexte au complet... → à confirmer » ; JAMAIS de "
        "doublon.\n"
        "- Ne signale JAMAIS en « corrections » un retrait/additif purement "
        "typographique de la liste de médicaments (virgule, point-virgule, "
        "point, normalisation d'abréviation/unité) sans changement de sens "
        "clinique — seules comptent les corrections qui portent un SENS "
        "clinique (nom de médicament, dose, voie, fréquence à confirmer).\n"
